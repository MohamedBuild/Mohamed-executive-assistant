---
name: recap-pipeline
description: Pull the full sales pipeline from Google Sheets and produce a structured summary saved to briefings/. Use when asked for a pipeline recap, deal overview, lead summary, or pipeline status.
when_to_use: Triggered by '/recap-pipeline' or when Mohamed asks about the pipeline, active leads, deal totals, or who to follow up with.
argument-hint: (no arguments needed)
disable-model-invocation: false
allowed-tools: mcp__zapier__list_enabled_zapier_actions mcp__zapier__discover_zapier_actions mcp__zapier__enable_zapier_action mcp__zapier__execute_zapier_read_action Write
---
